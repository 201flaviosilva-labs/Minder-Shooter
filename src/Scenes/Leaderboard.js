...
export default class Leaderboard extends Phaser.Scene {
	...
	create() {
		...
		const title = this.add.text(middleWidth, 50, "Leaderboard", TextStyle.leaderboard.title).setOrigin(0.5);
		...
		{ // Exit
			const exit = this.add.text(middleWidth, height - 30, settings.exit, TextStyle.leaderboard.exit).setOrigin(0.5);
